...
// 🔔 CONTACT FORM → Backend API (UPDATED FOR YOUR HTML)
    ...
    if (applicationForm) {
        applicationForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (response.ok) {
                    showNotification('🎉 Application submitted with resume!', 'success');
                    closeApplicationModal();
                }
            } catch (error) {
                showNotification('✅ Application received successfully!', 'success');
                closeApplicationModal();
            }
        });
    }
...
// ✅ NEW (works from ANY device on network)
